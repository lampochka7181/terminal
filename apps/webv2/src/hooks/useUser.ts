...
export function useUser() {
  ...
  // NOTE: Don't call fetchAll() here on isAuthenticated change!
  // useAuth already calls fetchAllUser() after sign-in.
  // Having both caused duplicate request floods (10+ API calls per auth).
