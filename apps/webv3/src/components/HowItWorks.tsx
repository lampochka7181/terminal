...
function SectionTitle({ children }: { children: string }) {
  return (
    <h2 style={{
      fontSize: 27, fontWeight: 600, color: '#eee', margin: '0 0 12px',
...
function Card({ children }: { children: React.ReactNode }) {
  return (
    <div style={{
      padding: '21px 24px', borderRadius: 12,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: '24px 42px', flexShrink: 0,
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          <svg width="33" height="60" viewBox="0 0 24 44" fill="none">
            <path d="M13 2L4 14h7l-2 8 11-12h-7l2-8z" fill="#eee" />
          </svg>
          <span style={{ fontSize: 33, fontWeight: 400, color: '#eee' }}>flip</span>
        </div>
        <button
          onClick={onClose}
          style={{
      ...
      {/* Scrollable content */}
      <div style={{
        flex: 1, overflowY: 'auto', padding: '0 42px 60px',
        display: 'flex', flexDirection: 'column', alignItems: 'center',
      }}>
        <div style={{ maxWidth: 825, width: '100%' }}>
          {/* Hero */}
          <div style={{ textAlign: 'center', marginBottom: 48 }}>
            <h1 style={{
              fontSize: 54, fontWeight: 500, color: '#eee', margin: '0 0 15px',
              letterSpacing: '-0.01em',
            }}>
              How It Works
            </h1>
            <p style={{
              fontSize: 23, color: 'rgba(238,238,238,0.5)', margin: 0,
              lineHeight: 1.5, maxWidth: 525, marginLeft: 'auto', marginRight: 'auto',
            }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 30, marginBottom: 48 }}>
            ...
            <div style={{ display: 'flex', gap: 18 }}>
              <Card>
                <div style={{
                  width: 42, height: 42, borderRadius: 11, background: '#001eff',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  fontSize: 21, fontWeight: 700, color: '#fff', marginBottom: 12,
                }}>1</div>
                <h3 style={{ fontSize: 21, fontWeight: 600, color: '#eee', margin: '0 0 8px' }}>Connect Wallet</h3>
                <p style={{ fontSize: 17, color: 'rgba(238,238,238,0.55)', margin: 0, lineHeight: 1.6 }}>
              ...
              <Card>
                ...
                <h3 style={{ fontSize: 21, fontWeight: 600, color: '#eee', margin: '0 0 8px' }}>Delegate USDC</h3>
                <p style={{ fontSize: 17, color: 'rgba(238,238,238,0.55)', margin: 0, lineHeight: 1.6 }}>
              ...
              <Card>
                ...
                <h3 style={{ fontSize: 21, fontWeight: 600, color: '#eee', margin: '0 0 8px' }}>Place a Trade</h3>
                <p style={{ fontSize: 17, color: 'rgba(238,238,238,0.55)', margin: 0, lineHeight: 1.6 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 18, marginBottom: 48 }}>
            ...
            <Card>
              <div style={{ display: 'flex', gap: 30, alignItems: 'flex-start' }}>
                <div style={{ flex: 1 }}>
                  <p style={{ fontSize: 18, color: 'rgba(238,238,238,0.66)', margin: '0 0 12px', lineHeight: 1.6 }}>
                  ...
                  <p style={{ fontSize: 15, color: 'rgba(238,238,238,0.4)', margin: '12px 0 0', lineHeight: 1.5 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 18, marginBottom: 48 }}>
            ...
            <div style={{ display: 'flex', gap: 18 }}>
              <Card>
                <div style={{
                  display: 'inline-flex', padding: '6px 15px', borderRadius: 8,
                  background: 'rgba(238,238,238,0.08)', marginBottom: 12,
                }}>
                  <span style={{ fontSize: 18, fontWeight: 700, color: '#eee' }}>Lite</span>
                </div>
                <p style={{ fontSize: 17, color: 'rgba(238,238,238,0.55)', margin: '0 0 12px', lineHeight: 1.6 }}>
                  The default view. A clean, streamlined interface designed for fast one-click trading.
                </p>
                <ul style={{ margin: 0, paddingLeft: 21, display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {[
              ...
              <Card>
                <div style={{
                  display: 'inline-flex', padding: '6px 15px', borderRadius: 8,
                  background: 'rgba(0,30,255,0.2)', marginBottom: 12,
                }}>
                  <span style={{ fontSize: 18, fontWeight: 700, color: '#6b8aff' }}>Pro</span>
                </div>
                <p style={{ fontSize: 17, color: 'rgba(238,238,238,0.55)', margin: '0 0 12px', lineHeight: 1.6 }}>
            ...
            <p style={{ fontSize: 17, color: 'rgba(238,238,238,0.4)', margin: 0, lineHeight: 1.5 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 18, marginBottom: 48 }}>
            ...
            <Card>
              ...
              <div style={{ display: 'flex', gap: 15, marginBottom: 15 }}>
                <div style={{
                  flex: 1, padding: '15px 18px', borderRadius: 9,
                  background: 'rgba(149,255,148,0.06)', border: '1px solid rgba(149,255,148,0.15)',
                }}>
                  <div style={{ fontSize: 20, fontWeight: 700, color: '#95ff94', marginBottom: 6 }}>Above wins</div>
                  <p style={{ fontSize: 15, color: 'rgba(238,238,238,0.55)', margin: 0, lineHeight: 1.5 }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: 20, fontWeight: 700, color: '#f55252', marginBottom: 6 }}>Below wins</div>
                  <p style={{ fontSize: 15, color: 'rgba(238,238,238,0.55)', margin: 0, lineHeight: 1.5 }}>
                    BTC closes below the strike when the timer hits zero. Payout = your amount × the multiplier shown.
                  </p>
                </div>
              </div>
              <p style={{ fontSize: 15, color: 'rgba(238,238,238,0.4)', margin: 0, lineHeight: 1.5 }}>
          ...
          <div style={{ textAlign: 'center', paddingBottom: 30 }}>
            <button
              onClick={onClose}
              style={{
                padding: '21px 60px', borderRadius: 11,
                background: '#001eff', border: 'none',
                color: '#eee', fontSize: 24, fontWeight: 700,
